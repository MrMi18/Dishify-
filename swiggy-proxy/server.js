...
// Proxy route for restaurants list
...
app.get("/api/menu/:restaurantId", async (req, res) => {
  ...
  console.log("Proxy endpoint hit for menu");
  console.log("Fetching menu data from Swiggy API:", url);
...
app.get("/api/collection/:collection_id/:tags", async (req, res) => {
