...
const ResMenu = () => {
  ...
  return (
    <div className="mt-24">
      ...
      >
        <h2 className="text-3xl font-bold mb-4 text-gray-800 uppercase tracking-wide">
          {name}
        </h2>

        <div className="text-left m-2 border rounded-lg w-8/12 p-5 flex flex-col gap-y-4 shadow-lg shadow-gray-300 bg-white">
          {/* Restaurant Details */}
          <div
